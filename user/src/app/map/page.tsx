...
export default function MapPage() {
  ...
  const initializeMap = () => {
    if (!isClient || !mapRef.current || mapInitializedRef.current || !window.L) return
    ...
    try {
      ...
      // マーカーを追加
      window.L.marker([35.6298, 139.7962], { icon: mainStageIcon }).addTo(map).bindPopup("メインステージ")
      window.L.marker([35.6305, 139.7975], { icon: foodIcon }).addTo(map).bindPopup("フードエリア")
      window.L.marker([35.629, 139.795], { icon: shopIcon }).addTo(map).bindPopup("グッズショップ")
    } catch (error) {
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">主要なパフォーマンスが行われるエリアです。</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">様々な飲食店が出店しているエリアです。</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">オフィシャルグッズを購入できるエリアです。</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">ゆっくり休憩できるスペースです。</p>
                  </div>
                </div>
              </div>
            </CardContent>
